...
1. Download the latest `HotAlert.exe` from [Releases](https://github.com/ArthurZou/hotAlert/releases) (or build from source)
2. Place the executable in any directory
3. Double-click to run
4. Configuration is automatically created at `%AppData%\HotAlert\config.json`

### **Installer Version**
1. Run the Inno Setup installer ([HotAlert_Setup.exe](https://github.com/ArthurZou/hotAlert/releases))
